import { mockEncrypter, mockHashComparer, mockLoadAccounbtByEmailRepository, mockUpdateAccessTokenRepository } from "@/data/test"
...
const makeSut = (): SutTypes => {
    const loadAccountByEmailRepositoryStub = mockLoadAccounbtByEmailRepository()
...
describe('DbAuthentication UseCase', () => {
    ...
    test('Should call HashCompare withcorrect values', async () => {
    ...
    test('Should call Encrypter returns id', async () => {
        const { sut } = makeSut()
