...
exports.default = (router) => {
    router.post('/signup', (0, express_route_adapter_1.adapterRoute)((0, signup_factory_1.makeSignUpController)()));
    router.post('/login', (0, express_route_adapter_1.adapterRoute)((0, login_factory_1.makeLoginController)()));
};
