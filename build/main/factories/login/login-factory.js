...
const log_mongo_respository_1 = require("../../../infra/db/mongodb/log/log-mongo-respository");
...
const makeLoginController = () => {
    ...
    const logMongoRepository = new log_mongo_respository_1.LogMongoRepository();
